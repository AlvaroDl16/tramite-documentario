        ...
        <ul class="nav__links">
            ...
            <li >
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo $ulr_base;?>secciones/direccion/recibidos.php" class="submenu__link white_mode"><i class="fa-solid fa-caret-right"></i>Recibidos <span class="alert"><?php echo $num_pendientes['pendientes']; ?></span></a></li>
