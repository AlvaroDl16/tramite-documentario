...
}elseif ($_SESSION['cargo'] !== "secretaria" || $_SESSION['area_cargo'] !== "secretaria academica") {
...
<aside class="sidebar">
    ...
    <nav class="nav__container">
        <ul class="nav__links">
            <li>
                <a href="<?php echo $ulr_base;?>secciones/secretaria_academica/index.php" class="link white_mode"><i class="fa-solid fa-house"></i>Inicio</a>
            </li>
            <li >
