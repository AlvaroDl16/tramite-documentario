<?php include("../../templates/header_secretaria_academica.php") ?>
    ...
    <h1>inicio secretaria academica</h1>
    <form action="" method="post">
            <label for="fecha">Fecha de envio: <input type="date" name="fecha" id="fecha"></label>
            ...
            <label for="archivo">Archivo: <input type="file"></label> <br>
